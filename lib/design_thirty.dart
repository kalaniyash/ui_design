...
class ThirtyDesign extends StatefulWidget {
  const ThirtyDesign({super.key});

  @override
  State<ThirtyDesign> createState() => _TwelDesignState();
}

class _TwelDesignState extends State<ThirtyDesign> {
  @override
